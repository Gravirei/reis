...
**IMPORTANT:** At the START of your debug analysis and at the END, display a kanban board showing current progress.
...
│             │ Debugging...│ Verify      │ [■■■■ 100% ■■■■] ✗ verifier │                 │
│             │  • Issue 1  │ Debug       │ [■■░░ XX%  ░░░░] ◉ debugger │                 │
│             │  • Issue 2  │             │                             │                 │
└─────────────┴─────────────┴─────────────┴─────────────────────────────┴─────────────────┘
```
...
### Status Icons
- `✓` = Complete/Pass
- `◉` = Running (debug in progress)
- `○` = Waiting/Pending
- `✗` = Failed (verification failed, that's why we're debugging)
- `▶` = Current phase

### When to Display
1. **At Start:** Show debug beginning (Verify failed, Debug in progress)
2. **At End:** Show analysis complete with issues found and fix plan created
...
│             │             │ Execute     │ [■■■■ 100% ■■■■] ✓ executor │                 │
│             │ Debugging   │ Verify      │ [■■■■ 100% ■■■■] ✗ verifier │                 │
│             │  • 2 issues │ Debug       │ [■■■■ 100% ■■■■] ✓ debugger │                 │
│             │             │             │                             │                 │
│             │ FIX_PLAN.md │ Fix         │ [░░░░  -   ░░░░] ○ next     │                 │
│             │ created     │             │                             │                 │
└─────────────┴─────────────┴─────────────┴─────────────────────────────┴─────────────────┘

🔧 Debug Complete - FIX_PLAN.md generated with 2 targeted fixes.
```
