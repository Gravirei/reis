 ...
 */
function parseChangelog(version: string) {
 ...
 */
function displaySectionContent(content: string, w: any, c: any) {
 ...
 * @param {Object} args - {}
 */
export function whatsNew(args: any) {
...
`));
  ...
  if (!changelog.found) {
    ...
    console.log(c('   ~/.rovodev/reis/README.md or ~/.gemini/reis/README.md'));
    console.log('');
    return;
  }
  ...
  console.log(c('   ~/.rovodev/reis/CHANGELOG.md or ~/.gemini/reis/CHANGELOG.md'));
  console.log('');
