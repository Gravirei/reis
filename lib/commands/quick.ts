...
import { showPrompt, showError, showSuccess, showWarning, checkPlanningDir } from '../utils/command-helpers.js';
 ...
 */
function quick(args: any): number {
 ...
 */
function generateQuickPrompt(task: string, options: any): string {
