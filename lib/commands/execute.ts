...
import { showError, checkPlanningDir, validatePhaseNumber } from '../utils/command-helpers.js';
import { invokeSubagent, SubagentInvoker, buildExecutionContext } from '../utils/subagent-invoker.js';
import { showKanbanBoard, updateExecutorStatus } from '../utils/kanban-renderer.js';
import { DependencyParser } from '../utils/dependency-parser.js';
import { ParallelWaveScheduler } from '../utils/parallel-wave-scheduler.js';
import { ExecutionCoordinator } from '../utils/execution-coordinator.js';
 ...
 */
async function execute(args: any, options: any = {}) {
 ...
 */
async function executeParallel(planPath: string, phase: number, options: any = {}) {
 ...
 */
async function executeWave(wave: any, planPath: string, phase: number, options: any = {}) {
  const invoker = new SubagentInvoker({ verbose: options.verbose });
 ...
 */
async function executeSequential(planPath: string, phase: number, options: any) {
