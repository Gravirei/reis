...
import { diffTrees, formatDiff } from '../utils/decision-tree-differ.js';
import { lintTree, formatLintResults } from '../utils/decision-tree-linter.js';
 ...
 */
async function showTree(filePath: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function createFromTemplate(templateName: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function listTemplates(options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function lintTreeFile(filePath: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function diffTreeFiles(file1: string, file2: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function validateTreeFile(filePath: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
function exportTree(filePath: string, options: any = {}) {
 ...
 * @param {Object} options - Command options
 */
async function treeCommand(subcommand: string, args: string[] = [], options: any = {}) {
  switch (subcommand) {
    case 'show':
      if (args.length === 0) {
...
export = Object.assign(treeCommand, {
  showTree,
  createFromTemplate,
  listTemplates,
  validateTreeFile,
