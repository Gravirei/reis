...
import { showPrompt, showError, showSuccess, showWarning, showInfo, checkPlanningDir } from '../utils/command-helpers.js';
import { invokeSubagent } from '../utils/subagent-invoker.js';
 ...
 */
async function audit(args: any): Promise<number> {
  ...
  let integrationResult: any = { success: true, issues: [] };
 ...
 */
function generateAuditPrompt(options: any): string {
