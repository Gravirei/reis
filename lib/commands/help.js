...
module.exports = function help() {
  ...
  console.log(chalk.bold.yellow('\\nAutomated Workflow'));
  console.log('  ' + chalk.cyan('reis cycle [phase]') + '    Complete PLAN → EXECUTE → VERIFY → DEBUG cycle');
  console.log('  ' + chalk.cyan('reis cycle --resume') + '   Resume interrupted cycle');
  
  console.log(chalk.bold.yellow('\\nDecision Trees'));
  console.log('  ' + chalk.cyan('reis tree show <file>') + '      Display decision tree from file');
  console.log('  ' + chalk.cyan('reis tree list') + '             List available templates');
  console.log('  ' + chalk.cyan('reis tree new <template>') + '   Create tree from template');
  console.log('  ' + chalk.cyan('reis tree validate <file>') + ' Validate tree syntax');
  console.log('  ' + chalk.cyan('reis tree export <file>') + '   Export to HTML/SVG/Mermaid');
  console.log('  ' + chalk.cyan('reis tree diff <f1> <f2>') + '  Compare two trees');
  console.log('  ' + chalk.cyan('reis tree lint <file>') + '     Lint tree for issues');
  console.log('  ' + chalk.cyan('reis tree --interactive') + '   Interactive selection mode');
  
  console.log(chalk.bold.yellow('\\nDecision Tracking'));
  console.log('  ' + chalk.cyan('reis decisions list') + '       Show decision history');
  console.log('  ' + chalk.cyan('reis decisions show <id>') + '  View decision details');
  console.log('  ' + chalk.cyan('reis decisions revert <id>') + 'Revert a decision');
  console.log('  ' + chalk.cyan('reis decisions export') + '     Export to JSON/CSV');
  console.log('  ' + chalk.cyan('reis decisions stats') + '      Show decision statistics');
  ...
  console.log('  ' + chalk.cyan('reis config') + '           Manage REIS configuration');
