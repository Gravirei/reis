...
`));
  ...
  console.log(w('        --research             - Run reis_scout research before planning ') + chalk.green('(NEW)'));
  console.log(w('        --full-research        - Run reis_analyst + reis_scout before planning ') + chalk.green('(NEW)'));
  console.log(w('        --quick                - Fast mode: skip research, review, and gates ') + chalk.green('(NEW)'));
  console.log('');
  ...
  // Quick & Milestone Management (NEW)
  console.log(w('   Quick & Milestone Management ') + chalk.green('(NEW in v2.7)'));
  console.log(w('   ────────────────────────────'));
  console.log(w('   reis quick <task>           - Execute a quick task without full research/verification cycle'));
  console.log(w('        --no-commit            - Skip git commit after execution'));
  console.log(w('        --verify               - Run quick verification after execution'));
  console.log(w('   reis audit [milestone]      - Audit milestone completion and cross-phase integration'));
  console.log(w('        --phase <n>            - Audit single phase instead of milestone'));
  console.log(w('        --strict               - Fail on any incomplete item or integration issue'));
  console.log(w('        --output <file>        - Custom output location for report'));
  console.log(w('   reis complete-milestone <m> - Archive completed milestone (runs audit first)'));
  console.log(w('        --no-tag               - Skip git tag creation'));
  console.log(w('        --no-archive           - Skip archiving phase plans'));
  console.log(w('        --skip-audit           - Skip audit verification (dangerous)'));
  console.log(w('   reis plan-gaps [milestone]  - Identify and plan for tech debt before milestone completion'));
  console.log(w('        --priority <level>     - Filter by priority (high|medium|low|all)'));
  console.log(w('        --dry-run              - Preview gaps without generating plans'));
  console.log('');
