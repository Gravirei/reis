...
`));
  ...
  console.log(w('   ──────────────────'));
  console.log(w('   reis cycle [phase]          - Run the complete automated workflow: PLAN → EXECUTE → VERIFY → GATE → DEBUG'));
  ...
  console.log(w('        --gate-only <category> - Run only specific gate category (security|quality|performance|accessibility)'));
  console.log('');
