...
`));
  ...
  console.log(w('   ─────────'));
  console.log(w('   reis execute <phase>        - Execute a phase using reis_executor subagent'));
  ...
  console.log(w('   ────────────'));
  console.log(w('   reis verify [target]        - Verify execution results using reis_verifier subagent'));
  console.log(w('        --dry-run              - Show prompt without executing'));
  ...
  console.log(w('   reis debug [target]         - Analyze failures using reis_debugger subagent'));
  console.log(w('        --dry-run              - Show prompt without executing'));
