...
import * as decisionTracker from '../utils/decision-tracker.js';
import { createTable, formatTimestamp } from '../utils/visualizer.js';
import fs from 'fs';
 ...
 */
function listDecisions(options: DecisionCommandOptions = {}): void {
 ...
 * @param {Object} options - Command options
 */
function showDecision(decisionId: string, options: DecisionCommandOptions = {}): void {
  ...
  if (decision.reverted) {
    console.log(chalk.bold('Reverted At:'), formatTimestamp(new Date(decision.revertedAt as string)));
 ...
 * @param {Object} options - Command options
 */
function revertDecision(decisionId: string, options: DecisionCommandOptions = {}): void {
 ...
 * @param {Object} options - Command options
 */
function exportDecisions(options: DecisionCommandOptions = {}): void {
 ...
 * @param {Object} options - Command options
 */
function showStatistics(options: DecisionCommandOptions = {}): void {
  const stats = decisionTracker.getStatistics() as unknown as DecisionStats;
 ...
 * @param {Object} options - Command options
 */
function deleteDecision(decisionId: string, options: DecisionCommandOptions = {}): void {
  // Find decision
  const allDecisions = decisionTracker.getDecisions();
  const decision = allDecisions.find(d => 
    d.id === decisionId || d.id.startsWith(decisionId)
 ...
 * @param {Object} options - Command options
 */
function decisionsCommand(subcommand: string, args: string[] = [], options: DecisionCommandOptions = {}): void {
  switch (subcommand) {
    case 'list':
...
export = Object.assign(decisionsCommand, {
  listDecisions,
  showDecision,
  revertDecision,
  exportDecisions,
