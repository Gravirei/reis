...
class KanbanBoard {
  ...
  formatCycleColumn(cycleState) {
    ...
    const stageConfig = [
      { name: 'Research', subagent: 'scout', icon: '🔬' },
      { name: 'Planning', subagent: 'planner', icon: '📝' },
      { name: 'Review', subagent: 'reviewer', icon: '📋' },
      { name: 'Execute', subagent: 'executor', icon: '⚡' },
      { name: 'Verify', subagent: 'verifier', icon: '🔍' },
      { name: 'Gate', subagent: 'gate', icon: '🛡️' },
      { name: 'Debug', subagent: 'debugger', icon: '🐛' }
    ];
